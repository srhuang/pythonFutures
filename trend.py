...
for line in lineList:
	...
	if OrderPrice==0 and (close_price>(open_point+entry_signal) or close_price<(open_point-entry_signal)):
		OrderPrice=close_price
		OrderTime=candle_time
		if OrderPrice>open_point:
			direction=1
		else:
			direction=-1
		continue

	#check the Cover prize
